...
flags.DEFINE_string("env_name", "rware-small-10ag-v1", "env name")
...
def cbs_planning(warehouse):
    ...
    nearby_requested_shelves_loc = []
    for i in range(len(requested_shelves_loc)):
        nearby_requested_shelves_loc.append([requested_shelves_loc[i][0]-1, requested_shelves_loc[i][1]])
        nearby_requested_shelves_loc.append([requested_shelves_loc[i][0], requested_shelves_loc[i][1]-1])
        nearby_requested_shelves_loc.append([requested_shelves_loc[i][0]+1, requested_shelves_loc[i][1]])
        nearby_requested_shelves_loc.append([requested_shelves_loc[i][0], requested_shelves_loc[i][1]+1])
    # print('Nearby requested shelves:', nearby_requested_shelves_loc)
    ...
    for shelf_loc in shelves_loc:
        ...
        # if shelf_loc in nearby_carrying_shelves_loc and shelf_loc in nearby_requested_shelves_loc:
